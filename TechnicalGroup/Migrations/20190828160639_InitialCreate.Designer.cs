...
namespace TechnicalGroup.Migrations
{
    ...
    [Migration("20190828160639_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechnicalGroup.Models.PostTags", b =>
                {
                    b.Property<int>("PostID");
            ...
            modelBuilder.Entity("TechnicalGroup.Models.Settings", b =>
                {
                    ...
                    b.Property<string>("GITphoto");

                    b.Property<string>("MainBannerDesc")
                        .IsRequired();

                    b.Property<string>("MainBannerDesc_Az");

                    b.Property<string>("MainBannerDesc_Ru");
            ...
            modelBuilder.Entity("TechnicalGroup.Models.Tag", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("TagName_Az");

                    b.Property<string>("TagName_Ru");
            ...
            modelBuilder.Entity("TechnicalGroup.Models.Team", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("MemberInfo_Az");

                    b.Property<string>("MemberInfo_Ru");
                    ...
                    b.Property<string>("MemberPosition_Az");

                    b.Property<string>("MemberPosition_Ru");
            ...
            modelBuilder.Entity("TechnicalGroup.Models.PostTags", b =>
                {
                    ...
                    b.HasOne("TechnicalGroup.Models.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
